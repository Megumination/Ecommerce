...
<head>
    ...
    <script>
        const isUserLoggedIn = <?php echo isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true ? 'true' : 'false'; ?>;
    </script>
</head>
...
<body>
    ...
    <form class="carrinho-body" action="finalizar_pedido.php" method="post">
        <div class="carrinho-container">
            ...
            <div class="carrinho-items">
                <h2>🛒 CARRINHO</h2>
                <p class="aviso-retirada">
                    Ao reservar pelo site, seu caderno ficará separado!<br>
                    A retirada é feita <strong>na Sala 7 (projetos E-commerces)</strong> <br>
                    é só fazer o Pix lá na hora e pegar seu produto com a gente.
                </p>
                <div id="lista-produtos-carrinho">
                </div>
                <p id="carrinho-vazio" style="display: none; text-align: center; margin-top: 20px;">Seu carrinho está
                    vazio.</p>
            </div>
    ...
    <script>
        ...
        // Adiciona um listener para o formulário inteiro
        document.querySelector('.carrinho-body').addEventListener('submit', function (event) {
            // Se o usuário NÃO estiver logado
            if (!isUserLoggedIn) {
                // 1. Impede o envio do formulário para "finalizar_pedido.php"
                event.preventDefault();

                // 2. Mostra um alerta para o usuário
                alert('Você precisa fazer login para finalizar a compra!');

                // 3. Redireciona o usuário para a página de login
                window.location.href = 'login.php';
            }
            // Se o usuário ESTIVER logado, o código não faz nada e o formulário
            // é enviado normalmente.
        });
    </script>
</body>
